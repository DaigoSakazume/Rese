...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $東京都 = Area::where('name', '東京都')->first()->id;
        $大阪府 = Area::where('name', '大阪府')->first()->id;
        $福岡県 = Area::where('name', '福岡県')->first()->id;

        $寿司 = Genre::where('name', '寿司')->first()->id;
        $焼肉 = Genre::where('name', '焼肉')->first()->id;
        $居酒屋 = Genre::where('name', '居酒屋')->first()->id;
        $イタリアン = Genre::where('name', 'イタリアン')->first()->id;
        $ラーメン = Genre::where('name', 'ラーメン')->first()->id;
